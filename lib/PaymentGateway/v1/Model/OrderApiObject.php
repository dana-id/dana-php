...
class OrderApiObject extends BaseModel
{
    public const DISCRIMINATOR = null;

    protected static $openAPIModelName = 'OrderApiObject';
    ...
    public function setOrderTitle($orderTitle)
    {
        ...
        if ((mb_strlen($orderTitle) > 64)) {
            throw new \InvalidArgumentException('invalid length for $orderTitle when calling OrderApiObject., must be smaller than or equal to 64.');
        }
    ...
    public function setMerchantTransType($merchantTransType)
    {
        ...
        if ((mb_strlen($merchantTransType) > 64)) {
            throw new \InvalidArgumentException('invalid length for $merchantTransType when calling OrderApiObject., must be smaller than or equal to 64.');
        }
    ...
    public function setExtendInfo($extendInfo)
    {
        ...
        if ((mb_strlen($extendInfo) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $extendInfo when calling OrderApiObject., must be smaller than or equal to 4096.');
        }
    ...
    public function setScenario($scenario)
    {
        ...
        if ((mb_strlen($scenario) > 64)) {
            throw new \InvalidArgumentException('invalid length for $scenario when calling OrderApiObject., must be smaller than or equal to 64.');
        }
