...
class CancelOrderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets responseCode
     *
     * @param string $responseCode Response code. Refer to https://dashboard.dana.id/api-docs/read/117#HTML-API-CancelOrder-ResponseCodeandMessage
     *
     * @return self
     */
     ...
     *
     * @param string $responseMessage Response message. Refer to https://dashboard.dana.id/api-docs/read/117#HTML-API-CancelOrder-ResponseCodeandMessage
     *
     * @return self
     */
     ...
     *
     * @param string|null $originalReferenceNo Original transaction identifier on DANA system. Present if successfully processed
     *
     * @return self
     */
     ...
     * Sets cancelTime
     *
     * @param string|null $cancelTime Cancellation date time, in format YYYY-MM-DDTHH:mm:ss+07:00. Time must be in GMT+7 (Jakarta time). Present if successfully processed
     *
     * @return self
     */
