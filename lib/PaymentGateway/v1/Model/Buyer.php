...
class Buyer extends BaseModel
{
    ...
    public function setExternalUserType($externalUserType)
    {
        ...
        if ((mb_strlen($externalUserType) > 32)) {
            throw new \InvalidArgumentException('invalid length for $externalUserType when calling Buyer., must be smaller than or equal to 32.');
        }
    ...
    public function setExternalUserId($externalUserId)
    {
        ...
        if ((mb_strlen($externalUserId) > 32)) {
            throw new \InvalidArgumentException('invalid length for $externalUserId when calling Buyer., must be smaller than or equal to 32.');
        }
    ...
    public function setUserId($userId)
    {
        ...
        if ((mb_strlen($userId) > 32)) {
            throw new \InvalidArgumentException('invalid length for $userId when calling Buyer., must be smaller than or equal to 32.');
        }
