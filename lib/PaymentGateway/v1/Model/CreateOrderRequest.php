...
class CreateOrderRequest extends BaseModel
{
    ...
    public function setPartnerReferenceNo($partnerReferenceNo)
    {
        ...
        if ((mb_strlen($partnerReferenceNo) > 64)) {
            throw new \InvalidArgumentException('invalid length for $partnerReferenceNo when calling CreateOrderRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setMerchantId($merchantId)
    {
        ...
        if ((mb_strlen($merchantId) > 64)) {
            throw new \InvalidArgumentException('invalid length for $merchantId when calling CreateOrderRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setSubMerchantId($subMerchantId)
    {
        ...
        if ((mb_strlen($subMerchantId) > 32)) {
            throw new \InvalidArgumentException('invalid length for $subMerchantId when calling CreateOrderRequest., must be smaller than or equal to 32.');
        }
    ...
    public function setExternalStoreId($externalStoreId)
    {
        ...
        if ((mb_strlen($externalStoreId) > 64)) {
            throw new \InvalidArgumentException('invalid length for $externalStoreId when calling CreateOrderRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setValidUpTo($validUpTo)
    {
        ...
        if ((mb_strlen($validUpTo) > 25)) {
            throw new \InvalidArgumentException('invalid length for $validUpTo when calling CreateOrderRequest., must be smaller than or equal to 25.');
        }
    ...
    public function setDisabledPayMethods($disabledPayMethods)
    {
        ...
        if ((mb_strlen($disabledPayMethods) > 64)) {
            throw new \InvalidArgumentException('invalid length for $disabledPayMethods when calling CreateOrderRequest., must be smaller than or equal to 64.');
        }
