...
/**
 * FinishNotifyResponse Class Doc Comment
 *
 * @category Class
 * @package  Dana\PaymentGateway
 * @author   OpenAPI Generator team
 ...
 */
class FinishNotifyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinishNotifyResponse';
    ...
    */
     ...
     * Sets response_code
     *
     * @param string $response_code Response code. Refer to https://dashboard.dana.id/api-docs/read/123#HTML-API-FinishNotify-ResponseCodeandMessage
     *
     * @return self
     */
    public function setResponseCode($response_code)
    {
        ...
        if ((mb_strlen($response_code) > 7)) {
            throw new \InvalidArgumentException('invalid length for $response_code when calling FinishNotifyResponse., must be smaller than or equal to 7.');
        }
     ...
     *
     * @param string $response_message Response message. Refer to https://dashboard.dana.id/api-docs/read/123#HTML-API-FinishNotify-ResponseCodeandMessage
     *
     * @return self
     */
    public function setResponseMessage($response_message)
    {
        ...
        if ((mb_strlen($response_message) > 150)) {
            throw new \InvalidArgumentException('invalid length for $response_message when calling FinishNotifyResponse., must be smaller than or equal to 150.');
        }
