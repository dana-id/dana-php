...
/**
 * CreateOrderBaseAdditionalInfo Class Doc Comment
 *
 * @category Class
 * @package  Dana\PaymentGateway
 * @author   OpenAPI Generator team
 ...
 */
class CreateOrderBaseAdditionalInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateOrderBaseAdditionalInfo';
    ...
    */
    ...
    public function setMcc($mcc)
    {
        ...
        if ((mb_strlen($mcc) > 64)) {
            throw new \InvalidArgumentException('invalid length for $mcc when calling CreateOrderBaseAdditionalInfo., must be smaller than or equal to 64.');
        }
    ...
    public function setExtendInfo($extend_info)
    {
        ...
        if ((mb_strlen($extend_info) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $extend_info when calling CreateOrderBaseAdditionalInfo., must be smaller than or equal to 4096.');
        }
