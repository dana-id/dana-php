...
class VirtualAccountInfo extends BaseModel
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['signature']) && (mb_strlen($this->container['signature']) > 128)) {
            $invalidProperties[] = "invalid value for 'signature', the character length must be smaller than or equal to 128.";
        }
    ...
    public function setSignature($signature)
    {
        ...
        if ((mb_strlen($signature) > 128)) {
            throw new \InvalidArgumentException('invalid length for $signature when calling VirtualAccountInfo., must be smaller than or equal to 128.');
        }
