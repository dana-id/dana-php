...
class ShippingInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets chargeAmount
     *
     * @param \Dana\PaymentGateway\v1\Model\Money|null $chargeAmount Promo amount. Contains two sub-fields:<br> 1. Value: Transaction amount, including the cents<br> 2. Currency: Currency code based on ISO<br>
     *
     * @return self
     */
