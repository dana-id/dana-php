...
class Goods implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets price
     *
     * @param \Dana\PaymentGateway\v1\Model\Money $price Goods price. Contains two sub-fields:<br> 1. Value: Transaction amount, including the cents<br> 2. Currency: Currency code based on ISO<br>
     *
     * @return self
     */
