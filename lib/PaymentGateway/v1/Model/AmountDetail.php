...
class AmountDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'order_amount' => '\Dana\PaymentGateway\v1\Model\Money',
        'pay_amount' => '\Dana\PaymentGateway\v1\Model\Money',
        'void_amount' => '\Dana\PaymentGateway\v1\Model\Money',
        'confirm_amount' => '\Dana\PaymentGateway\v1\Model\Money',
        'refund_amount' => '\Dana\PaymentGateway\v1\Model\Money',
        'chargeback_amount' => '\Dana\PaymentGateway\v1\Model\Money',
    ...
    */
     ...
     * Sets order_amount
     *
     * @param \Dana\PaymentGateway\v1\Model\Money $order_amount Order amount. Contains two sub-fields:<br> 1. Value: Transaction amount, including the cents<br> 2. Currency: Currency code based on ISO<br>
     *
     * @return self
     */
     ...
     * Sets void_amount
     *
     * @param \Dana\PaymentGateway\v1\Model\Money|null $void_amount Void amount. Contains two sub-fields:<br> 1. Value: Transaction amount, including the cents<br> 2. Currency: Currency code based on ISO<br>
     *
     * @return self
     */
     ...
     * Sets confirm_amount
     *
     * @param \Dana\PaymentGateway\v1\Model\Money|null $confirm_amount Confirm amount. Contains two sub-fields:<br> 1. Value: Transaction amount, including the cents<br> 2. Currency: Currency code based on ISO<br>
     *
     * @return self
     */
     ...
     * Sets refund_amount
     *
     * @param \Dana\PaymentGateway\v1\Model\Money|null $refund_amount Refund amount. Contains two sub-fields:<br> 1. Value: Transaction amount, including the cents<br> 2. Currency: Currency code based on ISO<br>
     *
     * @return self
     */
     ...
     *
     * @param \Dana\PaymentGateway\v1\Model\Money|null $chargeback_amount Chargeback amount. Contains two sub-fields:<br> 1. Value: Transaction amount, including the cents<br> 2. Currency: Currency code based on ISO<br>
     *
     * @return self
     */
