    ...
    */
    ...
    public function setOrderTitle($order_title)
    {
        ...
        if ((mb_strlen($order_title) > 64)) {
            throw new \InvalidArgumentException('invalid length for $order_title when calling OrderBase., must be smaller than or equal to 64.');
        }
    ...
    public function setMerchantTransType($merchant_trans_type)
    {
        ...
        if ((mb_strlen($merchant_trans_type) > 64)) {
            throw new \InvalidArgumentException('invalid length for $merchant_trans_type when calling OrderBase., must be smaller than or equal to 64.');
        }
    ...
    public function setExtendInfo($extend_info)
    {
        ...
        if ((mb_strlen($extend_info) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $extend_info when calling OrderBase., must be smaller than or equal to 4096.');
        }
