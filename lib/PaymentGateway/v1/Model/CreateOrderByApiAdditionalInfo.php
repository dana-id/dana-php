...
/**
 * CreateOrderByApiAdditionalInfo Class Doc Comment
 *
 * @category Class
 * @package  Dana\PaymentGateway
 * @author   OpenAPI Generator team
 ...
 */
class CreateOrderByApiAdditionalInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setExtendInfo($extend_info)
    {
        ...
        if ((mb_strlen($extend_info) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $extend_info when calling CreateOrderByApiAdditionalInfo., must be smaller than or equal to 4096.');
        }
     ...
     * Gets order
     *
     * @return \Dana\PaymentGateway\v1\Model\OrderApiObject|null
     */
     ...
     * Sets order
     *
     * @param \Dana\PaymentGateway\v1\Model\OrderApiObject|null $order Additional information of order
     *
     * @return self
     */
