...
class ConsultPayPaymentInfo extends BaseModel
{
    ...
    public const PAY_OPTION_NETWORK_PAY_PL_INDODANA = 'NETWORK_PAY_PL_INDODANA';
    ...
    public const PAY_OPTION_VIRTUAL_ACCOUNT_BSI_PAYMENT = 'VIRTUAL_ACCOUNT_BSI_PAYMENT';
