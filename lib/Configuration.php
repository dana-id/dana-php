...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.sandbox.dana.id';
     ...
     * Constructor
     * 
     * Initializes configuration with environment variables:
    ...
    public function __construct()
    {
        ...
        if ($origin) {
            $this->setApiKey('ORIGIN', $origin);
        }
        
        if ($partnerId) {
            $this->setApiKey('X_PARTNER_ID', $partnerId);
        }
        
        if ($privateKey) {
            $this->setApiKey('PRIVATE_KEY', $privateKey);
        }
    ...
    public function getHostSettings()
    {
        ...
        return [
            [
                "url" => $this->getEnvironmentBaseUrl($env),
                "description" => $env === Env::PRODUCTION ? "Production environment" : "Sandbox environment",
            ]
        ];
    }
    ...
    */
     ...
     * 
     * @param string $env Environment name (sandbox or production)
     * 
     * @return string Base URL for the specified environment
     */
    private function getEnvironmentBaseUrl($env)
    {
        switch ($env) {
            case Env::PRODUCTION:
