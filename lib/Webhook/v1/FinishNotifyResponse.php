...
class FinishNotifyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets responseCode
     *
     * @param string $responseCode Response code. Refer to https://dashboard.dana.id/api-docs/read/123#HTML-API-FinishNotify-ResponseCodeandMessage
     *
     * @return self
     */
    public function setResponseCode($responseCode)
    {
        ...
        if ((mb_strlen($responseCode) > 7)) {
            throw new \InvalidArgumentException('invalid length for $responseCode when calling FinishNotifyResponse., must be smaller than or equal to 7.');
        }
     ...
     *
     * @param string $responseMessage Response message. Refer to https://dashboard.dana.id/api-docs/read/123#HTML-API-FinishNotify-ResponseCodeandMessage
     *
     * @return self
     */
    public function setResponseMessage($responseMessage)
    {
        ...
        if ((mb_strlen($responseMessage) > 150)) {
            throw new \InvalidArgumentException('invalid length for $responseMessage when calling FinishNotifyResponse., must be smaller than or equal to 150.');
        }
