...
class PayOptionInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'payMethod' => 'string',
        'payOption' => 'string',
        'payAmount' => '\Dana\Webhook\v1\Money',
        'transAmount' => '\Dana\Webhook\v1\Money',
        'chargeAmount' => '\Dana\Webhook\v1\Money',
    ...
    */
     ...
     * Gets payAmount
     *
     * @return \Dana\Webhook\v1\Money|null
     */
     ...
     * Sets payAmount
     *
     * @param \Dana\Webhook\v1\Money|null $payAmount Pay amount. Contains two sub-fields:<br> 1. Value: Transaction amount, including the cents<br> 2. Currency: Currency code based on ISO<br>
     *
     * @return self
     */
     ...
     * Sets transAmount
     *
     * @param \Dana\Webhook\v1\Money|null $transAmount Trans amount. Contains two sub-fields:<br> 1. Value: Transaction amount, including the cents<br> 2. Currency: Currency code based on ISO<br>
     *
     * @return self
     */
     ...
     * Sets chargeAmount
     *
     * @param \Dana\Webhook\v1\Money|null $chargeAmount Charge amount. Contains two sub-fields:<br> 1. Value: Transaction amount, including the cents<br> 2. Currency: Currency code based on ISO<br>
     *
     * @return self
     */
