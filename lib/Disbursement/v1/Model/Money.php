...
class Money implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets value
     *
     * @param string $value Value of amount. Following ISO-4217, for IDR the value includes 2 decimal digits separated with point e.g. ,IDR 10.000,- will be placed with 10000.00
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string $currency Currency. Following ISO-4217
     *
     * @return self
     */
