...
class TransferToBankInquiryStatusRequest extends BaseModel
{
    public const DISCRIMINATOR = null;

    protected static $openAPIModelName = 'TransferToBankInquiryStatusRequest';
    ...
    public function setOriginalPartnerReferenceNo($originalPartnerReferenceNo)
    {
        ...
        if ((mb_strlen($originalPartnerReferenceNo) > 64)) {
            throw new \InvalidArgumentException('invalid length for $originalPartnerReferenceNo when calling TransferToBankInquiryStatusRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setOriginalReferenceNo($originalReferenceNo)
    {
        ...
        if ((mb_strlen($originalReferenceNo) > 64)) {
            throw new \InvalidArgumentException('invalid length for $originalReferenceNo when calling TransferToBankInquiryStatusRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setOriginalExternalId($originalExternalId)
    {
        ...
        if ((mb_strlen($originalExternalId) > 36)) {
            throw new \InvalidArgumentException('invalid length for $originalExternalId when calling TransferToBankInquiryStatusRequest., must be smaller than or equal to 36.');
        }
    ...
    public function setServiceCode($serviceCode)
    {
        ...
        if ((mb_strlen($serviceCode) > 2)) {
            throw new \InvalidArgumentException('invalid length for $serviceCode when calling TransferToBankInquiryStatusRequest., must be smaller than or equal to 2.');
        }
