...
/**
 * TransferToBankInquiryStatusRequest Class Doc Comment
 *
 * @category Class
 * @package  Dana\Disbursement
 * @author   OpenAPI Generator team
 ...
 */
class TransferToBankInquiryStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $original_partner_reference_no Original transaction identifier on partner system<br> Notes:<br> Required to be filled using the partnerReferenceNo that is the same as the one used in Transfer to Bank
     *
     * @return self
     */
    public function setOriginalPartnerReferenceNo($original_partner_reference_no)
    {
        ...
        if ((mb_strlen($original_partner_reference_no) > 64)) {
            throw new \InvalidArgumentException('invalid length for $original_partner_reference_no when calling TransferToBankInquiryStatusRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setOriginalReferenceNo($original_reference_no)
    {
        ...
        if ((mb_strlen($original_reference_no) > 64)) {
            throw new \InvalidArgumentException('invalid length for $original_reference_no when calling TransferToBankInquiryStatusRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setOriginalExternalId($original_external_id)
    {
        ...
        if ((mb_strlen($original_external_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $original_external_id when calling TransferToBankInquiryStatusRequest., must be smaller than or equal to 36.');
        }
    ...
    public function setServiceCode($service_code)
    {
        ...
        if ((mb_strlen($service_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $service_code when calling TransferToBankInquiryStatusRequest., must be smaller than or equal to 2.');
        }
