...
/**
 * BankAccountInquiryRequestAdditionalInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class BankAccountInquiryRequestAdditionalInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankAccountInquiryRequest_additionalInfo';
