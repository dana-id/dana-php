...
/**
 * InternationalOrderInfoExchangeRate Class Doc Comment
 *
 * @category Class
 * @description Define the detail of exchange rate information
 * @package  Dana\Widget
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InternationalOrderInfoExchangeRate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InternationalOrderInfo_exchangeRate';
    ...
    */
     ...
     * Sets rate
     *
     * @param string|null $rate Rate of exchange value represents the relation between two currencies. For example, 15917.2690 indicates that one USD is equivalent to 15917.2690 IDR
     *
     * @return self
     */
