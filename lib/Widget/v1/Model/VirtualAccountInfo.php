...
class VirtualAccountInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string $virtualAccountCode Virtual account code (required if payMethod is VIRTUAL_ACCOUNT)
     *
     * @return self
     */
     ...
     *
     * @param string $virtualAccountExpiryTime Expiry time of virtual account in format YYYY-MM-DDTHH:mm:ss+07:00 (Jakarta time)
     *
     * @return self
     */
