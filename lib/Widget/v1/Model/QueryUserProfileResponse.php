...
class QueryUserProfileResponse extends BaseModel
{
    public const DISCRIMINATOR = null;

    protected static $openAPIModelName = 'QueryUserProfileResponse';

    protected static $openAPITypes = [
        'response' => '\Dana\Widget\v1\Model\QueryUserProfileResponseResponse',
        'signature' => 'string'
    ];
