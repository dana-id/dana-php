...
class RefundOrderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets refundAmount
     *
     * @param \Dana\Widget\v1\Model\Money $refundAmount Refund amount. Contains two sub-fields - 1. Value (Amount, including the cents) and 2. Currency (Currency code based on ISO)
     *
     * @return self
     */
