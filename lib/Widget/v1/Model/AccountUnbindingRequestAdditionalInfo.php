...
class AccountUnbindingRequestAdditionalInfo extends BaseModel
{
    public const DISCRIMINATOR = null;

    protected static $openAPIModelName = 'AccountUnbindingRequestAdditionalInfo';
    ...
    public function setAccessToken($accessToken)
    {
        ...
        if ((mb_strlen($accessToken) > 512)) {
            throw new \InvalidArgumentException('invalid length for $accessToken when calling AccountUnbindingRequestAdditionalInfo., must be smaller than or equal to 512.');
        }
    ...
    public function setEndUserIpAddress($endUserIpAddress)
    {
        ...
        if ((mb_strlen($endUserIpAddress) > 15)) {
            throw new \InvalidArgumentException('invalid length for $endUserIpAddress when calling AccountUnbindingRequestAdditionalInfo., must be smaller than or equal to 15.');
        }
    ...
    public function setDeviceId($deviceId)
    {
        ...
        if ((mb_strlen($deviceId) > 400)) {
            throw new \InvalidArgumentException('invalid length for $deviceId when calling AccountUnbindingRequestAdditionalInfo., must be smaller than or equal to 400.');
        }
    ...
    public function setLatitude($latitude)
    {
        ...
        if ((mb_strlen($latitude) > 10)) {
            throw new \InvalidArgumentException('invalid length for $latitude when calling AccountUnbindingRequestAdditionalInfo., must be smaller than or equal to 10.');
        }
        if ((!preg_match("/^[-+]?[0-9]{1,2}([.][0-9]{1,4})?$/", ObjectSerializer::toString($latitude)))) {
            throw new \InvalidArgumentException("invalid value for \$latitude when calling AccountUnbindingRequestAdditionalInfo., must conform to the pattern /^[-+]?[0-9]{1,2}([.][0-9]{1,4})?$/.");
        }
    ...
    public function setLongitude($longitude)
    {
        ...
        if ((mb_strlen($longitude) > 10)) {
            throw new \InvalidArgumentException('invalid length for $longitude when calling AccountUnbindingRequestAdditionalInfo., must be smaller than or equal to 10.');
        }
        if ((!preg_match("/^[-+]?[0-9]{1,2}([.][0-9]{1,4})?$/", ObjectSerializer::toString($longitude)))) {
            throw new \InvalidArgumentException("invalid value for \$longitude when calling AccountUnbindingRequestAdditionalInfo., must conform to the pattern /^[-+]?[0-9]{1,2}([.][0-9]{1,4})?$/.");
        }
