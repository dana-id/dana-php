...
/**
 * AccountUnbindingRequestAdditionalInfo Class Doc Comment
 *
 * @category Class
 * @package  Dana\Widget
 * @author   OpenAPI Generator team
 ...
 */
class AccountUnbindingRequestAdditionalInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setAccessToken($access_token)
    {
        ...
        if ((mb_strlen($access_token) > 512)) {
            throw new \InvalidArgumentException('invalid length for $access_token when calling AccountUnbindingRequestAdditionalInfo., must be smaller than or equal to 512.');
        }
    ...
    public function setEndUserIpAddress($end_user_ip_address)
    {
        ...
        if ((mb_strlen($end_user_ip_address) > 15)) {
            throw new \InvalidArgumentException('invalid length for $end_user_ip_address when calling AccountUnbindingRequestAdditionalInfo., must be smaller than or equal to 15.');
        }
    ...
    public function setDeviceId($device_id)
    {
        ...
        if ((mb_strlen($device_id) > 400)) {
            throw new \InvalidArgumentException('invalid length for $device_id when calling AccountUnbindingRequestAdditionalInfo., must be smaller than or equal to 400.');
        }
