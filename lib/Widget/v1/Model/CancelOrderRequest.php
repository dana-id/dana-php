...
class CancelOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets amount
     *
     * @param \Dana\Widget\v1\Model\Money|null $amount Amount. Contains two sub fields - Value (Transaction amount, including the cents) and Currency (Currency code based on ISO 4217)
     *
     * @return self
     */
