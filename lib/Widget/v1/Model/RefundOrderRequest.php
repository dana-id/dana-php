...
class RefundOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets refundAmount
     *
     * @param \Dana\Widget\v1\Model\Money $refundAmount Refund amount. Contains two sub-fields - 1. Value (Transaction amount, including the cents) and 2. Currency (Currency code based on ISO)
     *
     * @return self
     */
     ...
     * Sets additionalInfo
     *
     * @param \Dana\Widget\v1\Model\RefundOrderRequestAdditionalInfo|null $additionalInfo additionalInfo
     *
     * @return self
     */
