...
class RefundOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'reason' => 'string',
        'additional_info' => '\Dana\Widget\v1\Model\RefundOrderRequestAdditionalInfo'
    ];
    ...
    */
     ...
     * Sets refund_amount
     *
     * @param \Dana\Widget\v1\Model\Money $refund_amount Refund amount. Contains two sub-fields - 1. Value (Transaction amount, including the cents) and 2. Currency (Currency code based on ISO)
     *
     * @return self
     */
     ...
     *
     * @return \Dana\Widget\v1\Model\RefundOrderRequestAdditionalInfo|null
     */
     ...
     *
     * @param \Dana\Widget\v1\Model\RefundOrderRequestAdditionalInfo|null $additional_info additional_info
     *
     * @return self
     */
