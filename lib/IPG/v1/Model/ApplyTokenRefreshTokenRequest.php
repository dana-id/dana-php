...
class ApplyTokenRefreshTokenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['auth_code']) && (mb_strlen($this->container['auth_code']) > 256)) {
    ...
    public function setGrantType($grant_type)
    {
        ...
        if ((mb_strlen($grant_type) > 64)) {
            throw new \InvalidArgumentException('invalid length for $grant_type when calling ApplyTokenRefreshTokenRequest., must be smaller than or equal to 64.');
        }
     ...
     * Sets auth_code
     *
     * @param string|null $auth_code Authorization code. Please refer to https://dashboard.dana.id/api-docs/read/125. Required if grantType is AUTHORIZATION_CODE
     *
     * @return self
     */
    public function setAuthCode($auth_code)
    {
        ...
        if ((mb_strlen($auth_code) > 256)) {
            throw new \InvalidArgumentException('invalid length for $auth_code when calling ApplyTokenRefreshTokenRequest., must be smaller than or equal to 256.');
        }
    ...
    public function setRefreshToken($refresh_token)
    {
        ...
        if ((mb_strlen($refresh_token) > 512)) {
            throw new \InvalidArgumentException('invalid length for $refresh_token when calling ApplyTokenRefreshTokenRequest., must be smaller than or equal to 512.');
        }
