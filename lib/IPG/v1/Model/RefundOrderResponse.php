...
class RefundOrderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets refund_amount
     *
     * @param \Dana\IPG\v1\Model\Money $refund_amount Refund amount. Contains two sub-fields - 1. Value (Amount, including the cents) and 2. Currency (Currency code based on ISO)
     *
     * @return self
     */
