...
/**
 * IPGPaymentResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class IPGPaymentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IPGPaymentResponse';
    ...
    */
    ...
    public function setResponseCode($response_code)
    {
        ...
        if ((mb_strlen($response_code) > 7)) {
            throw new \InvalidArgumentException('invalid length for $response_code when calling IPGPaymentResponse., must be smaller than or equal to 7.');
        }
    ...
    public function setResponseMessage($response_message)
    {
        ...
        if ((mb_strlen($response_message) > 150)) {
            throw new \InvalidArgumentException('invalid length for $response_message when calling IPGPaymentResponse., must be smaller than or equal to 150.');
        }
    ...
    public function setReferenceNo($reference_no)
    {
        ...
        if ((mb_strlen($reference_no) > 64)) {
            throw new \InvalidArgumentException('invalid length for $reference_no when calling IPGPaymentResponse., must be smaller than or equal to 64.');
        }
    ...
    public function setPartnerReferenceNo($partner_reference_no)
    {
        ...
        if ((mb_strlen($partner_reference_no) > 64)) {
            throw new \InvalidArgumentException('invalid length for $partner_reference_no when calling IPGPaymentResponse., must be smaller than or equal to 64.');
        }
    ...
    public function setWebRedirectUrl($web_redirect_url)
    {
        ...
        if ((mb_strlen($web_redirect_url) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $web_redirect_url when calling IPGPaymentResponse., must be smaller than or equal to 2048.');
        }
