...
/**
 * ApplyOTTResponseUserResourcesInner Class Doc Comment
 *
 * @category Class
 * @package  Dana\IPG
 * @author   OpenAPI Generator team
 ...
 */
class ApplyOTTResponseUserResourcesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplyOTTResponse_userResources_inner';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value Value of OTT
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 64)) {
            throw new \InvalidArgumentException('invalid length for $value when calling ApplyOTTResponseUserResourcesInner., must be smaller than or equal to 64.');
        }
