...
class PaymentPromoInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'promo_name' => 'string',
        'promo_type' => 'string',
        'savings_amount' => '\Dana\IPG\v1\Model\Money'
    ];
    ...
    */
     ...
     * Sets savings_amount
     *
     * @param \Dana\IPG\v1\Model\Money $savings_amount Savings amount from this promotion. Contains value (amount including cents) and currency (code based on ISO)
     *
     * @return self
     */
