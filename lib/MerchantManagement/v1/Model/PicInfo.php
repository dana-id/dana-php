 ...
 */
class PicInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('picName', $data ?? [], null);
        $this->setIfExists('picPosition', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets picName
     *
     * @param string|null $picName PIC name
     *
     * @return self
     */
     ...
     * Sets picPosition
     *
     * @param string|null $picPosition PIC position
     *
     * @return self
     */
