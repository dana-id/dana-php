...
class QueryMerchantInfoResponseResponseHead extends BaseModel
{
    public const DISCRIMINATOR = null;

    protected static $openAPIModelName = 'QueryMerchantInfoResponseResponseHead';
    ...
    public const MODEL_FUNCTION_DANA_AP_BIZPROD_BIZ_SERVICE_OPENAPI_MERCHANT_QUERY_MERCHANT_INFO = 'dana.ap.bizprod.biz.service.openapi.merchant.queryMerchantInfo';

    public function getFunctionAllowableValues()
    {
        return [
            self::MODEL_FUNCTION_DANA_AP_BIZPROD_BIZ_SERVICE_OPENAPI_MERCHANT_QUERY_MERCHANT_INFO,
        ];
    }
    ...
    public function setVersion($version)
    {
        ...
        if ((mb_strlen($version) > 8)) {
            throw new \InvalidArgumentException('invalid length for $version when calling QueryMerchantInfoResponseResponseHead., must be smaller than or equal to 8.');
        }
    ...
    public function setFunction($function)
    {
        ...
        if ((mb_strlen($function) > 128)) {
            throw new \InvalidArgumentException('invalid length for $function when calling QueryMerchantInfoResponseResponseHead., must be smaller than or equal to 128.');
        }
    ...
    public function setClientId($clientId)
    {
        ...
        if ((mb_strlen($clientId) > 64)) {
            throw new \InvalidArgumentException('invalid length for $clientId when calling QueryMerchantInfoResponseResponseHead., must be smaller than or equal to 64.');
        }
    ...
    public function setRespTime($respTime)
    {
        ...
        if ((mb_strlen($respTime) > 25)) {
            throw new \InvalidArgumentException('invalid length for $respTime when calling QueryMerchantInfoResponseResponseHead., must be smaller than or equal to 25.');
        }
    ...
    public function setReqMsgId($reqMsgId)
    {
        ...
        if ((mb_strlen($reqMsgId) > 64)) {
            throw new \InvalidArgumentException('invalid length for $reqMsgId when calling QueryMerchantInfoResponseResponseHead., must be smaller than or equal to 64.');
        }
    ...
    public function setClientSecret($clientSecret)
    {
        ...
        if ((mb_strlen($clientSecret) > 128)) {
            throw new \InvalidArgumentException('invalid length for $clientSecret when calling QueryMerchantInfoResponseResponseHead., must be smaller than or equal to 128.');
        }
