...
class UpdateShopResponseResponse extends BaseModel
{
    public const DISCRIMINATOR = null;

    protected static $openAPIModelName = 'UpdateShopResponseResponse';

    protected static $openAPITypes = [
        'head' => '\Dana\MerchantManagement\v1\Model\UpdateShopResponseResponseHead',
