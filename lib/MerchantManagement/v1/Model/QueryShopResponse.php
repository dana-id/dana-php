...
class QueryShopResponse extends BaseModel
{
    public const DISCRIMINATOR = null;

    protected static $openAPIModelName = 'QueryShopResponse';

    protected static $openAPITypes = [
        'response' => '\Dana\MerchantManagement\v1\Model\QueryShopResponseResponse',
        'signature' => 'string'
    ];
