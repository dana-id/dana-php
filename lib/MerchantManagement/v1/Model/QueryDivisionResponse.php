...
class QueryDivisionResponse extends BaseModel
{
    public const DISCRIMINATOR = null;

    protected static $openAPIModelName = 'QueryDivisionResponse';

    protected static $openAPITypes = [
        'response' => '\Dana\MerchantManagement\v1\Model\QueryDivisionResponseResponse',
        'signature' => 'string'
    ];
