...
class UpdateShopResponse extends BaseModel
{
    public const DISCRIMINATOR = null;

    protected static $openAPIModelName = 'UpdateShopResponse';

    protected static $openAPITypes = [
        'response' => '\Dana\MerchantManagement\v1\Model\UpdateShopResponseResponse',
        'signature' => 'string'
    ];
