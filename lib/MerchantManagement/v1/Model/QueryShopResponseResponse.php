...
class QueryShopResponseResponse extends BaseModel
{
    public const DISCRIMINATOR = null;

    protected static $openAPIModelName = 'QueryShopResponseResponse';

    protected static $openAPITypes = [
        'head' => '\Dana\MerchantManagement\v1\Model\QueryShopResponseResponseHead',
        'body' => '\Dana\MerchantManagement\v1\Model\QueryShopResponseResponseBody'
    ];
