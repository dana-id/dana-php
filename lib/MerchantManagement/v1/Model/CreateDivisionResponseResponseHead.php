...
class CreateDivisionResponseResponseHead extends BaseModel
{
    public const DISCRIMINATOR = null;

    protected static $openAPIModelName = 'CreateDivisionResponseResponseHead';
    ...
    public const MODEL_FUNCTION_DANA_MERCHANT_DIVISION_CREATE_DIVISION = 'dana.merchant.division.createDivision';

    public function getFunctionAllowableValues()
    {
        return [
            self::MODEL_FUNCTION_DANA_MERCHANT_DIVISION_CREATE_DIVISION,
        ];
    }
    ...
    public function setVersion($version)
    {
        ...
        if ((mb_strlen($version) > 8)) {
            throw new \InvalidArgumentException('invalid length for $version when calling CreateDivisionResponseResponseHead., must be smaller than or equal to 8.');
        }
    ...
    public function setFunction($function)
    {
        ...
        if ((mb_strlen($function) > 128)) {
            throw new \InvalidArgumentException('invalid length for $function when calling CreateDivisionResponseResponseHead., must be smaller than or equal to 128.');
        }
    ...
    public function setClientId($clientId)
    {
        ...
        if ((mb_strlen($clientId) > 36)) {
            throw new \InvalidArgumentException('invalid length for $clientId when calling CreateDivisionResponseResponseHead., must be smaller than or equal to 36.');
        }
    ...
    public function setClientSecret($clientSecret)
    {
        ...
        if ((mb_strlen($clientSecret) > 64)) {
            throw new \InvalidArgumentException('invalid length for $clientSecret when calling CreateDivisionResponseResponseHead., must be smaller than or equal to 64.');
        }
    ...
    public function setRespTime($respTime)
    {
        ...
        if ((mb_strlen($respTime) > 25)) {
            throw new \InvalidArgumentException('invalid length for $respTime when calling CreateDivisionResponseResponseHead., must be smaller than or equal to 25.');
        }
    ...
    public function setReqMsgId($reqMsgId)
    {
        ...
        if ((mb_strlen($reqMsgId) > 64)) {
            throw new \InvalidArgumentException('invalid length for $reqMsgId when calling CreateDivisionResponseResponseHead., must be smaller than or equal to 64.');
        }
    ...
    public function setReserve($reserve)
    {
        ...
        if ((mb_strlen($reserve) > 256)) {
            throw new \InvalidArgumentException('invalid length for $reserve when calling CreateDivisionResponseResponseHead., must be smaller than or equal to 256.');
        }
