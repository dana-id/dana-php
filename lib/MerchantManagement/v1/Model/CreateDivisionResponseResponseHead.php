...
/**
 * CreateDivisionResponseResponseHead Class Doc Comment
 *
 * @category Class
 * @package  Dana\MerchantManagement
 * @author   OpenAPI Generator team
 ...
 */
class CreateDivisionResponseResponseHead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateDivisionResponse_response_head';
    ...
    */
     ...
     * Sets clientSecret
     *
     * @param string|null $clientSecret As a secret key of client. Assigned client secret during registration
     *
     * @return self
     */
     ...
     * Sets respTime
     *
     * @param string|null $respTime Response time, in format YYYY-MM-DDTHH:mm:ss+07:00. Time must be in GMT+7 (Jakarta time)
     *
     * @return self
     */
