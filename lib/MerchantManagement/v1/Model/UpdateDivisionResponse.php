...
class UpdateDivisionResponse extends BaseModel
{
    public const DISCRIMINATOR = null;

    protected static $openAPIModelName = 'UpdateDivisionResponse';

    protected static $openAPITypes = [
        'response' => '\Dana\MerchantManagement\v1\Model\UpdateDivisionResponseResponse',
        'signature' => 'string'
    ];
