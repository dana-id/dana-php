...
class CreateShopResponseResponse extends BaseModel
{
    public const DISCRIMINATOR = null;

    protected static $openAPIModelName = 'CreateShopResponseResponse';

    protected static $openAPITypes = [
        'head' => '\Dana\MerchantManagement\v1\Model\CreateShopResponseResponseHead',
        'body' => '\Dana\MerchantManagement\v1\Model\CreateShopResponseResponseBody'
    ];
