...
class CreateDivisionResponse extends BaseModel
{
    public const DISCRIMINATOR = null;

    protected static $openAPIModelName = 'CreateDivisionResponse';

    protected static $openAPITypes = [
        'response' => '\Dana\MerchantManagement\v1\Model\CreateDivisionResponseResponse',
        'signature' => 'string'
    ];
